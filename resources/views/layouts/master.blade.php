          ...
          <!-- INICIO NAVBAR -->
        	<nav class="navbar navbar-expand-sm" style="background-color:#b22222; font-family:'Amatic SC'; font-size:25px;">
              ...
              <nav class="cl-effect-14" style="margin-left:-10px;">
                <a class="text-light mr-5" href="http://dual.test/" style="text-decoration:none;">Inicio</a>
            ...
            <div class="col-12">
              <nav class="navbar navbar-expand-sm" style="background-color:#b22222; font-family:'Amatic SC'; font-size:25px;">
                  ...
                  <nav class="cl-effect-14" style="font-size:13px;">
                    <a class="text-light mr-5" href="http://dual.test/avisolegal" style="text-decoration:none;">Aviso Legal</a>
                    <a class="text-light mr-5" href="#" style="text-decoration:none;">Cookies</a>
